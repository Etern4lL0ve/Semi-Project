	...
	<div class="outer">
		<div class="list-container">
			...
			<div style="display: flex;">
					<a href="${contextPath}/list.bo?currentPage=1&category=꿀팁" class="btn btn-dark" style="margin-right: 10px;">전체</a>
					<c:forEach items="${categoryList}" var="cList">
						<a href="${contextPath}/ggulPostByCategory.po?currentPage=1&categoryNo=${cList.categoryNo}" class="btn btn-dark" style="margin-right: 10px;">${cList.categoryName}</a>
					</c:forEach>
			...
			<table class="list-area" align="center" border = "1">
				...
				<div class="wholeList" align="center">
	                ...
	                <c:choose>
	                    ...
	                    <c:otherwise>
	                        <button  class='btn btn-sm' onclick="location.href='list.bo?currentPage=${spi.currentPage+1}&category=꿀팁'">다음</button>
	                    </c:otherwise>
	                </c:choose>
				</div>
				<div class="wholeList" align="center" style="display:none;">
	                <c:choose>
	                    <c:when test="${pi.currentPage eq 1}">
	                        <button  class='btn btn-sm' disabled>이전</button>
	                    </c:when>
