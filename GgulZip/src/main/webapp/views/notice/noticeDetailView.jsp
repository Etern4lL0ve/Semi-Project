...
<body>
	...
	<div class="outer">
		...
		<br><br>
		<h2 align="left" style="margin-left: 520px; font-size: 24px; font-family: TheJamsil5Bold">${n.noticeTitle }</h2>
		<br>
		...
		<br><br>
		<div align="center">
			<button onclick="location.href='${contextPath}/nupdate.no?noticeNo=${n.noticeNo}'" class="button2">수정하기</button>
			<button onclick="location.href='${contextPath}/ndelete.no?noticeNo=${n.noticeNo}'" class="button3">삭제하기</button>
			<button onclick="location.href='${contextPath}/nlist.no?currentPage=1'" class="button1">목록가기</button>
		</div>
	</div>
</body>
</html>